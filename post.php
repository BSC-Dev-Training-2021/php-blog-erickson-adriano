                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="checkboxvar[]" type="checkbox" value="1" id="defaultCheck1">
                                                    <label class="form-check-label" for="defaultCheck1">
                                                      sports
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="checkboxvar[]" type="checkbox" value="2" id="defaultCheck2">
                                                    <label class="form-check-label" for="defaultCheck2">
                                                      politics
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="checkboxvar[]"type="checkbox" value="3" id="defaultCheck3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="checkboxvar[]" type="checkbox" value="4" id="defaultCheck4">
                                                    <label class="form-check-label" for="defaultCheck4">
                                                      music
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="checkboxvar[]" type="checkbox" value="5" id="defaultCheck5">
                                                    <label class="form-check-label" for="defaultCheck5">
                                                        artist
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input"name="checkboxvar[]" type="checkbox" value="6" id="defaultCheck6">
